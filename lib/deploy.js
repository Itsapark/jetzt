        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 12:
                    ...
                    return [3 /*break*/, 13];
                case 13:
                    log_1.log("Uploading public static assets to blob storage...", log_1.LogLevel.Verbose);
                    _a.label = 14;
                case 14:
                    _a.trys.push([14, 16, , 17]);
                    return [4 /*yield*/, exec_1.execAsync("az storage blob upload-batch --subscription " + subscriptionId + " --account-name " + storageAccount + " --destination " + assetsContainerName + " --destination-path public --source " + path_1.join(sourcePath, "public"))];
                case 15:
                    _a.sent();
                    return [3 /*break*/, 17];
                case 16:
                    e_9 = _a.sent();
                    exec_1.fail("Could not upload public assets to Azure blob storage", e_9);
                    return [3 /*break*/, 17];
